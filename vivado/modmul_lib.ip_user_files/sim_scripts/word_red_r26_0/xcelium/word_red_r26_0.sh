...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.word_red_r26_0
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.word_red_r26_0 -input simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/toluntosun/Desktop/PhD/fpga_acceleration/modmul_git/vivado/modmul_lib.cache/compile_simlib/xcelium"
  fi
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log word_red_r26_0_sc.so .tmp_log xcelium_lib waves.shm c.obj)
