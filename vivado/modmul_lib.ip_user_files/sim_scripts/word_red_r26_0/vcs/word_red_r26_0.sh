...
#                script (type 'word_red_r26_0.sh -help' for more information).
#
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.word_red_r26_0 -o word_red_r26_0_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./word_red_r26_0_simv $vcs_sim_opts -do simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/toluntosun/Desktop/PhD/fpga_acceleration/modmul_git/vivado/modmul_lib.cache/compile_simlib/vcs"
  fi
...
reset_run()
{
  files_to_remove=(ucli.key word_red_r26_0_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc word_red_r26_0_simv.daidir vcs_lib c.obj)
