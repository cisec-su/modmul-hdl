...
#
# Script generated by Vivado on Wed Sep 04 17:06:56 +03 2024
...
simulate()
{
  xsim word_red_r26_0 -key {Behavioral:sim_wr_mixed:Functional:word_red_r26_0} -tclbatch cmd.tcl -log simulate.log
}
