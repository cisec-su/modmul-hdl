...
#
# Script generated by Vivado on Thu Aug 29 19:06:08 +03 2024
# SW Build 3865809 on Sun May  7 15:04:56 MDT 2023
#
# Tool Version Limit: 2023.05 
#
# Filename     : word_red_r26_0.sh
...
#
# Usage        : word_red_r26_0.sh
#                word_red_r26_0.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                word_red_r26_0.sh [-reset_run]
#                word_red_r26_0.sh [-reset_log]
#                word_red_r26_0.sh [-help]
#
...
# script info
echo -e "word_red_r26_0.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./word_red_r26_0.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xbip_dsp48_wrapper_v3_0_4 -L xbip_utils_v3_0_10 -L xbip_pipe_v3_0_6 -L dsp_macro_v1_0_3 -L xil_defaultlib -L secureip -L xpm --snapshot word_red_r26_0 xil_defaultlib.word_red_r26_0 -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim word_red_r26_0 -key {Behavioral:sim_wordred_r26:Functional:word_red_r26_0} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb word_red_r26_0.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./word_red_r26_0.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: word_red_r26_0.sh [-help]\n\
Usage: word_red_r26_0.sh [-step]\n\
Usage: word_red_r26_0.sh [-lib_map_path]\n\
Usage: word_red_r26_0.sh [-reset_run]\n\
Usage: word_red_r26_0.sh [-reset_log]\n\
Usage: word_red_r26_0.sh [-keep_index]\n\
Usage: word_red_r26_0.sh [-noclean_files]\n\n\
