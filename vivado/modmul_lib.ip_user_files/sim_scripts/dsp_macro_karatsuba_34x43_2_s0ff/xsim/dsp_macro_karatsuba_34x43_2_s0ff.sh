...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xbip_dsp48_wrapper_v3_0_4 -L xbip_utils_v3_0_10 -L xbip_pipe_v3_0_6 -L dsp_macro_v1_0_3 -L xil_defaultlib -L secureip -L xpm --snapshot dsp_macro_karatsuba_34x43_2_s0ff xil_defaultlib.dsp_macro_karatsuba_34x43_2_s0ff -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim dsp_macro_karatsuba_34x43_2_s0ff -key {Behavioral:sim_1:Functional:dsp_macro_karatsuba_34x43_2_s0ff} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb dsp_macro_karatsuba_34x43_2_s0ff.wdb xsim.dir libdpi.so)
