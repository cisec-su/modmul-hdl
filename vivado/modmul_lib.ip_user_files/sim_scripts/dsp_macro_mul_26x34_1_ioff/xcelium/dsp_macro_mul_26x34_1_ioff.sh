...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.dsp_macro_mul_26x34_1_ioff
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.dsp_macro_mul_26x34_1_ioff -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log dsp_macro_mul_26x34_1_ioff_sc.so .tmp_log xcelium_lib waves.shm c.obj)
