...
#
# Script generated by Vivado on Wed Aug 07 00:33:04 +03 2024
...
# script info
echo -e "dsp_macro_1.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xbip_dsp48_wrapper_v3_0_4 -L xbip_utils_v3_0_10 -L xbip_pipe_v3_0_6 -L dsp_macro_v1_0_3 -L xil_defaultlib -L secureip -L xpm --snapshot dsp_macro_1 xil_defaultlib.dsp_macro_1 -log elaborate.log
}
