...
#                script (type 'dsp_macro_monty_26_v2_1_ioff.sh -help' for more information).
#
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.dsp_macro_monty_26_v2_1_ioff -o dsp_macro_monty_26_v2_1_ioff_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./dsp_macro_monty_26_v2_1_ioff_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key dsp_macro_monty_26_v2_1_ioff_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc dsp_macro_monty_26_v2_1_ioff_simv.daidir vcs_lib c.obj)
