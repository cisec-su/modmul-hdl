...
#
# Script generated by Vivado on Tue Aug 27 00:43:07 +03 2024
# SW Build 3865809 on Sun May  7 15:04:56 MDT 2023
#
# Tool Version Limit: 2023.05 
#
# Filename     : dsp_macro_monty_26_v2_1_ioff.sh
...
#
# Usage        : dsp_macro_monty_26_v2_1_ioff.sh
#                dsp_macro_monty_26_v2_1_ioff.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                dsp_macro_monty_26_v2_1_ioff.sh [-reset_run]
#                dsp_macro_monty_26_v2_1_ioff.sh [-reset_log]
#                dsp_macro_monty_26_v2_1_ioff.sh [-help]
#
...
# script info
echo -e "dsp_macro_monty_26_v2_1_ioff.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./dsp_macro_monty_26_v2_1_ioff.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xbip_dsp48_wrapper_v3_0_4 -L xbip_utils_v3_0_10 -L xbip_pipe_v3_0_6 -L dsp_macro_v1_0_3 -L xil_defaultlib -L secureip -L xpm --snapshot dsp_macro_monty_26_v2_1_ioff xil_defaultlib.dsp_macro_monty_26_v2_1_ioff -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim dsp_macro_monty_26_v2_1_ioff -key {Behavioral:sim_wr_mixed:Functional:dsp_macro_monty_26_v2_1_ioff} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb dsp_macro_monty_26_v2_1_ioff.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./dsp_macro_monty_26_v2_1_ioff.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: dsp_macro_monty_26_v2_1_ioff.sh [-help]\n\
Usage: dsp_macro_monty_26_v2_1_ioff.sh [-step]\n\
Usage: dsp_macro_monty_26_v2_1_ioff.sh [-lib_map_path]\n\
Usage: dsp_macro_monty_26_v2_1_ioff.sh [-reset_run]\n\
Usage: dsp_macro_monty_26_v2_1_ioff.sh [-reset_log]\n\
Usage: dsp_macro_monty_26_v2_1_ioff.sh [-keep_index]\n\
Usage: dsp_macro_monty_26_v2_1_ioff.sh [-noclean_files]\n\n\
