...
#
# Script generated by Vivado on Wed Aug 28 22:21:41 +03 2024
# SW Build 3865809 on Sun May  7 15:04:56 MDT 2023
#
# Tool Version Limit: 2023.05 
#
# Filename     : word_red_qh26_0.sh
...
#
# Usage        : word_red_qh26_0.sh
#                word_red_qh26_0.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                word_red_qh26_0.sh [-reset_run]
#                word_red_qh26_0.sh [-reset_log]
#                word_red_qh26_0.sh [-help]
#
...
#                script (type 'word_red_qh26_0.sh -help' for more information).
#
...
# script info
echo -e "word_red_qh26_0.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./word_red_qh26_0.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.word_red_qh26_0 -o word_red_qh26_0_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./word_red_qh26_0_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key word_red_qh26_0_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc word_red_qh26_0_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./word_red_qh26_0.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: word_red_qh26_0.sh [-help]\n\
Usage: word_red_qh26_0.sh [-step]\n\
Usage: word_red_qh26_0.sh [-lib_map_path]\n\
Usage: word_red_qh26_0.sh [-reset_run]\n\
Usage: word_red_qh26_0.sh [-reset_log]\n\
Usage: word_red_qh26_0.sh [-keep_index]\n\
Usage: word_red_qh26_0.sh [-noclean_files]\n\n\
