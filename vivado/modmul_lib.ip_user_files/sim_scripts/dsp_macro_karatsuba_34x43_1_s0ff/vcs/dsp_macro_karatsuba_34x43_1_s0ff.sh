...
#
# Script generated by Vivado on Wed Aug 07 11:10:11 +03 2024
# SW Build 3865809 on Sun May  7 15:04:56 MDT 2023
#
# Tool Version Limit: 2023.05 
#
# Filename     : dsp_macro_karatsuba_34x43_1_s0ff.sh
...
#
# Usage        : dsp_macro_karatsuba_34x43_1_s0ff.sh
#                dsp_macro_karatsuba_34x43_1_s0ff.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                dsp_macro_karatsuba_34x43_1_s0ff.sh [-reset_run]
#                dsp_macro_karatsuba_34x43_1_s0ff.sh [-reset_log]
#                dsp_macro_karatsuba_34x43_1_s0ff.sh [-help]
#
...
#                script (type 'dsp_macro_karatsuba_34x43_1_s0ff.sh -help' for more information).
#
...
# script info
echo -e "dsp_macro_karatsuba_34x43_1_s0ff.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./dsp_macro_karatsuba_34x43_1_s0ff.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.dsp_macro_karatsuba_34x43_1_s0ff -o dsp_macro_karatsuba_34x43_1_s0ff_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./dsp_macro_karatsuba_34x43_1_s0ff_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key dsp_macro_karatsuba_34x43_1_s0ff_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc dsp_macro_karatsuba_34x43_1_s0ff_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./dsp_macro_karatsuba_34x43_1_s0ff.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: dsp_macro_karatsuba_34x43_1_s0ff.sh [-help]\n\
Usage: dsp_macro_karatsuba_34x43_1_s0ff.sh [-step]\n\
Usage: dsp_macro_karatsuba_34x43_1_s0ff.sh [-lib_map_path]\n\
Usage: dsp_macro_karatsuba_34x43_1_s0ff.sh [-reset_run]\n\
Usage: dsp_macro_karatsuba_34x43_1_s0ff.sh [-reset_log]\n\
Usage: dsp_macro_karatsuba_34x43_1_s0ff.sh [-keep_index]\n\
Usage: dsp_macro_karatsuba_34x43_1_s0ff.sh [-noclean_files]\n\n\
