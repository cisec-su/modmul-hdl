...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.dsp_macro_karatsuba_34x43_0_iffs0s1ff
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.dsp_macro_karatsuba_34x43_0_iffs0s1ff -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log dsp_macro_karatsuba_34x43_0_iffs0s1ff_sc.so .tmp_log xcelium_lib waves.shm c.obj)
