...
class MontgomeryShiftTestRunner(automation.test_runner.TestRunner):
    ...
    def subclass_add_args(self):
        ...
        self.parser_add_tb_param("FF_SHF0", type=int, choices=[0, 1], default=1, help="Set FF_SHF0 (0 or 1)")
        self.parser_add_tb_param("FF_SHF1", type=int, choices=[0, 1], default=1, help="Set FF_SHF1 (0 or 1)")
        self.parser_add_tb_param("FF_SUB0", type=int, choices=[0, 1], default=1, help="Set FF_SUB0 (0 or 1)")
        self.parser_add_tb_param("FF_SUB1", type=int, choices=[0, 1], default=1, help="Set FF_SUB1 (0 or 1)")
